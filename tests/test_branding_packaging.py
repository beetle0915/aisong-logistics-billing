...
class BrandingPackagingTest(unittest.TestCase):
    def test_v8_3_branding_metadata(self) -> None:
        self.assertEqual(APP_DISPLAY_NAME, "艾松运费管家")
        self.assertEqual(APP_VERSION, "8.3")
        self.assertEqual(APP_VERSION_LABEL, "V8.3")
        self.assertEqual(OUTPUT_VERSION_SUFFIX, "v8_3")
