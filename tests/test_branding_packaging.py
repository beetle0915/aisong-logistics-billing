...
class BrandingPackagingTest(unittest.TestCase):
    def test_v8_10_3_branding_metadata(self) -> None:
        self.assertEqual(APP_DISPLAY_NAME, "艾松运费管家")
        self.assertEqual(APP_VERSION, "8.10.3")
        self.assertEqual(APP_VERSION_LABEL, "V8.10.3")
        self.assertEqual(OUTPUT_VERSION_SUFFIX, "v8_10_3")
    ...
    def test_packaging_icon_assets_are_wired(self) -> None:
        ...
        self.assertEqual(build_windows_exe.PACKAGE_DIR.name, "艾松运费管家-V8.10.3")
