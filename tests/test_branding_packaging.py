...
class BrandingPackagingTest(unittest.TestCase):
    def test_v8_8_2_branding_metadata(self) -> None:
        self.assertEqual(APP_DISPLAY_NAME, "艾松运费管家")
        self.assertEqual(APP_VERSION, "8.8.2")
        self.assertEqual(APP_VERSION_LABEL, "V8.8.2")
        self.assertEqual(OUTPUT_VERSION_SUFFIX, "v8_8_2")
