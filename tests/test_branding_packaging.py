...
class BrandingPackagingTest(unittest.TestCase):
    def test_v7_0_10_branding_metadata(self) -> None:
        self.assertEqual(APP_DISPLAY_NAME, "艾松运费管家")
        self.assertEqual(APP_VERSION, "7.0.10")
        self.assertEqual(APP_VERSION_LABEL, "V7.0.10")
        self.assertEqual(OUTPUT_VERSION_SUFFIX, "v7_0_10")
